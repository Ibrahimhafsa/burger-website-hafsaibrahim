...
export default function Progressor() {
  return (
    <div>
      <div className='flex items-start max-w-screen-lg w-full mx-auto mt-12 '>
       ...
       <div className='w-full'>
        ...
        <div className='mt-0 mr-4'>
          ...
          <p className='text-xs text-white'>Ready to eat? Proceed to checkout & complete your order!</p>
        </div>
       </div>
